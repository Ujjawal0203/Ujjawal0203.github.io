...
const Experience = () => {
  ...
  return (
    <div style={{marginBottom:"120px"}} name='experience' className='bg-gradient-to-b from-gray-800 to-black w-full text-white md:h-screen'>
        <div  className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
          ...
          <div  className='w-full grid sm:grid-cols-2 md:grid-cols-4 gap-8 px-12 sm:px-0'>
            ...
            <img src={src} style={{ width:"80%" }} alt="" className='rounded-md duration-500 mx-auto hover:scale-105' />
