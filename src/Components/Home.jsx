...
import myImage from '../assests/myImages.png';
    ...
    return (
        <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 sm:flex-row'>
                <div className='flex flex-col justify-center h-full' style={{ marginTop:"140px" }} >
                ...
                <div>
                    <img style={{ width: "80%" }} src={myImage} alt="my profile" className='rounded-2xl mx-auto w-1/3 md:w-1/3 ' />
                </div>
            </div>
        </div>
    )
