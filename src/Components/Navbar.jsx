...
const Navbar = () => {
  ...
  return (
    ...
    <div>
      <h1 className="font-signature text-4xl">Ujjawal</h1>
    </div>
    ...
    <li key={id} className='px-3 cursor-pointer font-medium capitalize text-gray-500 hover:scale-125 duration-200'>
      ...
      <a href="./Ujjawal_Resume.pdf" className=' flex justify-between items-center w-full px-3 cursor-pointer font-medium capitalize text-gray-500 hover:scale-125 duration-200' download target="_blank" rel='noreferrer'>
                    Resume
                </a>
